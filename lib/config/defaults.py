...
# The embedding interval for CTSR block.
_C.COTERE.INTERVAL = 1

# The embedding position for CTSR block.
_C.COTERE.EMBED_POS = "A"

# The collaborate type for CTSR block.
_C.COTERE.COLLABORATE_TYPE = "mul_sum"

# Whether or not use the first res unit for CTSR block.
_C.COTERE.USE_FIRST_UNIT = True

# The reduction ratio for CR.
_C.COTERE.C_MLP_R = 1.0

# The reduction ratio for TR.
_C.COTERE.T_MLP_R = 32.0

# The conv kernel size for SR.
_C.COTERE.S_CONV_SIZE = 3
...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["c2d", "i3d", "slow", "x3d", "r3d", "r2plus1d", "ip_csn", "ir_csn"]
